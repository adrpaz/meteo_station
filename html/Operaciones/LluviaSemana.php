...
include('../Configuraciones/bd.php');
    ...
    $fechaHace7Dias = date('Y-m-d', strtotime('-7 days', strtotime($fechaActual)));                                                         
    $query = "SELECT Lluvia FROM `tb_meteodata` WHERE Fecha <= '$fechaActual' AND Fecha > '$fechaHace7Dias'";           //Definimos la Query con la variable recibida (el % es para buscar todos los valores no solo el primero)
