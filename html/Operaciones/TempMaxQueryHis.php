...
include('../Configuraciones/bd.php');
    ...
    $query = "SELECT Temperatura2, Fecha FROM `tb_meteodata` WHERE Temperatura2 >= ALL (SELECT Temperatura2 FROM `tb_meteodata`)";           //Definimos la Query con la variable recibida (el % es para buscar todos los valores no solo el primero)
