...
include('../Configuraciones/bd.php');
    ...
    $query = "SELECT Temperatura FROM `tb_meteodata` WHERE Fecha = '$fechaActual'";           //Definimos la Query con la variable recibida (el % es para buscar todos los valores no solo el primero)
